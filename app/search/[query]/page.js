...
const search = ({ params }) => {
    ...
    async function getSearchedImages(e) {
        try {
            let { data } = await axios.get(`https://api.unsplash.com/search/photos?client_id=vDNZUWUFxvhAlDQUdnVU8k6JnYetF6XOQjATYnemf44&page=${searchResult.length}&query=${searchQuery}`)
